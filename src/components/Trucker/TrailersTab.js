...
function createData(trailerNum, insuranceNum, insuranceFile) {
  return { trailerNum, insuranceNum, insuranceFile };
}

const rows = [createData("W2341T", "A3144", "")];
